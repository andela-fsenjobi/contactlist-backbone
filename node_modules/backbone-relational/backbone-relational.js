...
(function (root, factory) {
  ...
  _.extend(Backbone.Relation.prototype, Backbone.Events, Backbone.Semaphore, {
    ...
    getReverseRelations: function (model) {
      ...
      var models = !_.isUndefined(model) ? [model] : this.related && (this.related.models || [this.related]), relations = null, relation = null;
  ...
  Backbone.RelationalModel = Backbone.Model.extend({
    ...
    getIdsToFetch: function (attr, refresh) {
      var rel = attr instanceof Backbone.Relation ? attr : this.getRelation(attr), ids = rel ? rel.keyIds && rel.keyIds.slice(0) || (rel.keyId || rel.keyId === 0 ? [rel.keyId] : []) : [];
    ...
    getAsync: function (attr, options) {
      ...
      if (idsToFetch && idsToFetch.length) {
        var models = [], createdModels = [], setUrl, createModels = function () {
